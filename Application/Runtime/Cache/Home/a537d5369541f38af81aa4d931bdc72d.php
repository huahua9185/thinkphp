...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="/thinkphp/Home/User/rule_add.html" method="post">
                <!-- #section:elements.form -->
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 规则名称</label>

                    <div class="col-sm-9">
                        <input id="form-field-1" placeholder="规则名称" class="col-xs-10 col-sm-5" type="text" name="title">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="form-field-1" placeholder="规则" class="col-xs-10 col-sm-5" type="text" name="name">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <input id="form-field-1" placeholder="状态" class="col-xs-2 col-sm-2" type="radio" name="status" value="1" checked="checked">启用
                    </div>
                    <div class="col-sm-1">
                        <input id="form-field-1" placeholder="状态" class="col-xs-2 col-sm-2" type="radio" name="status" value="0">禁用
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="form-field-1" placeholder="条件" class="col-xs-10 col-sm-5" type="text" name="condition">
                    </div>
                </div>
                <!-- /section:elements.form -->
