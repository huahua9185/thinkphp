...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="/thinkphp/Home/User/group_add.html" method="post">
                <!-- #section:elements.form -->
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 组名</label>

                    <div class="col-sm-9">
                        <input id="form-field-1" placeholder="组名" class="col-xs-10 col-sm-5" type="text" name="title">
                    </div>
                </div>
               ...
               <div class="row">
                   ...
                   <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><label class="checkbox-inline">
                           <input type="checkbox"  name="rules[]" value="<?php echo ($g["id"]); ?>"><?php echo ($g["title"]); ?>
