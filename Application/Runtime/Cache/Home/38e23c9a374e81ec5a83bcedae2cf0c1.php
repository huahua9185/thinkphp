...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="/thinkphp/Home/User/rule_edit.html?id=1" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input id="form-field-1"  class="col-xs-10 col-sm-5" type="text"
                               value="<?php echo ($rule["title"]); ?>" name="title">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 规则内容</label>

                    <div class="col-sm-9">
                        <input id="form-field-1" value="<?php echo ($rule["name"]); ?>" class="col-xs-10 col-sm-5" type="text" name="name">
                    </div>
                </div>
                <div class="form-group" >
                    ...
                    <div class="col-sm-1" >
                        <input id="radio-1" placeholder="状态" class="col-xs-2 col-sm-2" type="radio" name="status" value="1" <?php if($rule['status']==1) echo "checked='checked'" ;?>>启用
                    </div>
                    <div class="col-sm-1">
                        <input id="radio-2" placeholder="状态" class="col-xs-2 col-sm-2" type="radio" name="status" value="0" <?php if($rule['status']==0) echo "checked='checked'" ;?>>禁用
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 规则条件</label>

                    <div class="col-sm-9">
                        <input id="form-field-1" value="<?php echo ($rule["condition"]); ?>" class="col-xs-10 col-sm-5" type="text"
                               name="condition">
                    </div>
                </div>
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <button class="btn btn-info" type="submit" name='id' value="<?php echo ($rule["id"]); ?>">
